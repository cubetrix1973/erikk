...
/* Using BOTH the static HTML classes and the hydrated React classes we found live */
.framer-CaFNh .framer-jlnza5-container, .framer-CaFNh .framer-x12e3p-container {
  display: flex !important;
  order: 1 !important;
}
.framer-CaFNh .framer-14yq27-container, .framer-CaFNh .framer-9zxxrb-container {
  display: flex !important;
  order: 2 !important;
}
.framer-CaFNh .framer-1t5plof-container, .framer-CaFNh .framer-11cl96-container {
  display: flex !important;
  order: 3 !important;
}
.framer-CaFNh .framer-1ob0dnm-container, .framer-CaFNh .framer-1xzfylx-container {
  display: flex !important;
  order: 4 !important;
}
